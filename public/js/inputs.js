...
$('#add').click(function () {
    ...
    $('#table').append(
        ...
        <tr class="flex justify-between items-center mt-2">
            <td class="flex flex-start w-48"><input type="text" name="inputs[`+i+`][description]" class="border-grey border-2 rounded w-30  @error('inputs[`+i+`][description]')  @enderror" placeholder="Item description"></td>
